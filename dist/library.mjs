...
const _hoisted_5$8 = /*#__PURE__*/ _withScopeId$3(() => /*#__PURE__*/createElementVNode("span", { class: "visually-hidden" }, "Предыдущий", -1 /* HOISTED */));
const _hoisted_6$5 = [
  _hoisted_5$8
];
const _hoisted_7$4 = /*#__PURE__*/ _withScopeId$3(() => /*#__PURE__*/createElementVNode("span", { class: "visually-hidden" }, "Следующий", -1 /* HOISTED */));
const _hoisted_8$4 = [
  _hoisted_7$4
];
const _hoisted_9$4 = {
...
const _hoisted_13$4 = { class: "tbody" };
const _hoisted_14$4 = ["checked", "onChange"];
const _hoisted_15$4 = { key: 2 };
    ...
    createElementVNode("div", _hoisted_2$f, [
      createElementVNode("div", _hoisted_3$d, [
        createElementVNode("div", _hoisted_4$9, [
          ...
          }, _hoisted_8$4, 32 /* HYDRATE_EVENTS */)
        ]),
        createElementVNode("div", {
          ...
          (!$options.isPropsEmpty)
            ...
            : (openBlock(), createElementBlock("table", _hoisted_9$4, [
                createElementVNode("thead", _hoisted_10$4, [
                  createElementVNode("tr", null, [
                    (openBlock(true), createElementBlock(Fragment, null, renderList($props.titles, (title, index) => {
                      return (openBlock(), createElementBlock("th", { key: index }, [
                        (index === 'isSelectedAll')
                          ? (openBlock(), createElementBlock("input", _hoisted_11$4))
                          : (openBlock(), createElementBlock("span", _hoisted_12$4, toDisplayString(title), 1 /* TEXT */))
                      ]))
                    }), 128 /* KEYED_FRAGMENT */))
                  ])
                ]),
                createElementVNode("tbody", _hoisted_13$4, [
                          ...
                          (key === 'num')
                            ...
                            : (key === 'isSelected')
                              ? (openBlock(), createElementBlock("input", {
                                  ...
                                  type: "checkbox",
                                  checked: value,
                                  onChange: $event => ($options.setSelect(index))
                                }, null, 40 /* PROPS, HYDRATE_EVENTS */, _hoisted_14$4))
                              : (openBlock(), createElementBlock("p", _hoisted_15$4, toDisplayString(value), 1 /* TEXT */))
                        ]))
                      }), 128 /* KEYED_FRAGMENT */))
                    ]))
                  }), 128 /* KEYED_FRAGMENT */))
...
const _hoisted_104$1 = /*#__PURE__*/createElementVNode("h5", null, "Общая таможенная стоимость", -1 /* HOISTED */);
const _hoisted_105$1 = /*#__PURE__*/createElementVNode("div", { class: "inf-paragraph" }, [
          ...
          createElementVNode("form", _hoisted_84$3, [
            createElementVNode("div", _hoisted_85$3, [
              ...
              createElementVNode("div", _hoisted_87$2, [
                createElementVNode("div", _hoisted_88$2, [
                  withDirectives(createElementVNode("input", {
                    type: "text",
                    class: "form-control",
                    placeholder: "Сумма",
          ...
          createElementVNode("div", _hoisted_6$3, [
            createElementVNode("div", _hoisted_7$2, [
              createElementVNode("div", _hoisted_8$2, [
                createElementVNode("form", _hoisted_9$2, [
