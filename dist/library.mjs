import { openBlock, createElementBlock, createElementVNode, normalizeClass, Fragment, renderList, toDisplayString, pushScopeId, popScopeId, resolveComponent, createBlock, createCommentVNode, createVNode } from 'vue';
...
function render$8(_ctx, _cache, $props, $setup, $data, $options) {
  return (openBlock(), createElementBlock("input", _hoisted_1$6))
}
...
const _hoisted_5$1 = /*#__PURE__*/ _withScopeId$2(() => /*#__PURE__*/createElementVNode("span", { class: "visually-hidden" }, "Предыдущий", -1 /* HOISTED */));
const _hoisted_6 = [
  _hoisted_5$1
];
const _hoisted_7 = /*#__PURE__*/ _withScopeId$2(() => /*#__PURE__*/createElementVNode("span", { class: "visually-hidden" }, "Следующий", -1 /* HOISTED */));
const _hoisted_8 = [
  _hoisted_7
];
...
function render$5(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return (openBlock(), createElementBlock("li", _hoisted_1$4, [
    createElementVNode("span", _hoisted_2$4, toDisplayString($props.node.label), 1 /* TEXT */),
...
const _hoisted_3$1 = /*#__PURE__*/ _withScopeId$1(() => /*#__PURE__*/createElementVNode("i", { class: "fas fa-file" }, null, -1 /* HOISTED */));
...
function render$3(_ctx, _cache, $props, $setup, $data, $options) {
  return (openBlock(), createElementBlock("div", _hoisted_1$2, [
    createElementVNode("div", _hoisted_2$2, [
      _hoisted_3$1,
      createElementVNode("span", _hoisted_4$1, toDisplayString($props.filename), 1 /* TEXT */)
    ])
  ]))
}
...
const _hoisted_4 = /*#__PURE__*/ _withScopeId(() => /*#__PURE__*/createElementVNode("i", { class: "fas fa-folder folder-icon" }, null, -1 /* HOISTED */));
    ...
    (openBlock(true), createElementBlock(Fragment, null, renderList($data.dataFiles.folders, (children, folderName) => {
      return (openBlock(), createElementBlock("div", {
        ...
        createElementVNode("div", _hoisted_2$1, [
          ...
          _hoisted_4,
          createElementVNode("span", _hoisted_5, toDisplayString(folderName), 1 /* TEXT */)
        ]),
        createElementVNode("div", {
