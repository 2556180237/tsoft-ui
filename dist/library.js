                ...
                vue.createElementVNode("thead", _hoisted_10$4, [
                  vue.createElementVNode("tr", null, [
                    (vue.openBlock(true), vue.createElementBlock(vue.Fragment, null, vue.renderList($props.titles, (title, index) => {
                      return (vue.openBlock(), vue.createElementBlock("th", { key: index }, [
                        (index === 'isSelectedAll')
                          ? (vue.openBlock(), vue.createElementBlock("input", _hoisted_11$4))
                          : (vue.openBlock(), vue.createElementBlock("span", _hoisted_12$4, vue.toDisplayString(title), 1 /* TEXT */))
                      ]))
                    }), 128 /* KEYED_FRAGMENT */))
                  ])
                ]),
                vue.createElementVNode("tbody", _hoisted_13$4, [
                        ...
                        return (vue.openBlock(), vue.createElementBlock("td", { key: key }, [
                          (key === 'num')
                            ...
                            : (key === 'isSelected')
                              ...
                              : (vue.openBlock(), vue.createElementBlock("p", _hoisted_15$4, vue.toDisplayString(value), 1 /* TEXT */))
                        ]))
                      }), 128 /* KEYED_FRAGMENT */))
                    ]))
                  }), 128 /* KEYED_FRAGMENT */))
...
const _hoisted_105 = /*#__PURE__*/vue.createElementVNode("p", { class: "align-bcntr fs-5" }, "Уникальный идентификатор партии", -1 /* HOISTED */);
